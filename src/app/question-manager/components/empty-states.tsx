...
export function NoSubjectsState({ onAIDialogOpenChange }: NoSubjectsStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      <div className="w-20 h-20 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800/20 dark:to-gray-700/20 rounded-full flex items-center justify-center mb-6">
